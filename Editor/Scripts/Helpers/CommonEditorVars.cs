...
{
    public static class CommonEditorVars
    {
        public const float ToggleSize = 14f;
        public const float SpacingWidth = 20f;
        public const string IsEnabled = "_isEnabled";
        ...
        public const string IsIncluded = "_isIncluded";
    }
}